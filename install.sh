...
Path=${1:-Python-Workshop/}
echo "Cloning Git Repo at $Path..."
git clone -q https://github.com/NVCC-Tech-Club/Python-Workshop "$Path"
...
echo "Installation done! Open the directory 'Python-Workshop' in a code editor and activate the venv to get started!"